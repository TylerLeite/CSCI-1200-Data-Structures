...
int changeTimes(Time t1, Time& t2){
    label_stack((uintptr_t*)&t1, "t1, in");
    label_stack((uintptr_t*)&t2, "t2, in");
    
    t1.setHour(t1.getHour() + 1);
    t1.setMinute(t1.getMinute() + 1);
    t1.setSecond(t1.getSecond() + 1);

    t2.setHour(t2.getHour() + 1);
    t2.setMinute(t2.getMinute() + 1);
...
int main(){
    ...
    label_stack((uintptr_t*)&t1, "t1, out");
    label_stack((uintptr_t*)&t2, "t2, out");
    print_stack();
    changeTimes(t1, t2);
